...
- If `memosight` is not on PATH, tell the user to install it
  (`brew install MemoBloom/memosight/memosight` or `pip install memosight`)
  and stop — do not install it yourself.
